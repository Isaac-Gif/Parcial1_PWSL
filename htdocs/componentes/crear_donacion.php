<?php 
    ...
    if(isset($_POST["crear_donacion"])) {
        ...
        if(crear_donacion($_POST, $datos_adicionales, $conexion)) {
            $_SESSION["noticia"] = "Se ha creado la donacion correctamente";
        } else {
            $_SESSION["noticia"] = "Hubo un error al crear la donacion";
        }
    } else {
        $_SESSION["noticia"] = "Hubo un error al crear la donacion";
    }
