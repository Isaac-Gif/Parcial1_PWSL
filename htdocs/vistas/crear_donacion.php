<?php 
    ...
    } else if (!verificar_permisos_de_usuario($_SESSION["usuario_sesion_id"], "crear", $conexion)) {
        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <form action="../componentes/crear_donacion.php" method="POST">
                        <div class="mb-3">
                            <label for="dui" class="form-label">DUI</label>
                            <input name="dui" type="text" class="form-control" id="dui" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="donacion_inicial" type="text" class="form-control" id="donacion_inicial" required>
                        </div>
                        
                        <button type="submit" class="btn btn-primary" name="crear_donacion" value="true">Crear</button>
                    </form>
                </div>
            </div>
            <?php 
